...
<div class="container">
	...
	<div class="grids">
		<div class="progressbar-heading grids-heading">
			<h2>Vakantiehuis Registration</h2>
		</div>
				...
				<div class="panel panel-widget agile-validation register-form">
					<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
						<div class="input-info">
							<h3>Register  Vakantiehuis Form :</h3>
						</div>
						<div class="form-body form-body-info">
							<form action="" method="post">
								<div class="form-group valid-form">
									<input type="text" class="form-control" name="name" placeholder="Name Vacation home" required="" value="<?php echo !empty($vakantiehuisje['name'])?$vakantiehuisje['name']:''; ?>">
									<?php echo form_error('name','<span class="help-block">','</span>'); ?>
								</div>
								<div class="form-group has-feedback">
									<input type="text" cols="250" class="form-control" name="description" placeholder="Description" data-error="Description is invalid" required="" value="<?php echo !empty($vakantiehuisje['description'])?$vakantiehuisje['description']:''; ?>">
									<?php echo form_error('description','<span class="help-block">','</span>'); ?>
								</div>		
							<br />			
								<div class="form-group has-feedback">
									<input type="text" class="form-control" name="price_per_night" placeholder="Price per night &euro;" data-error="Price per night is invalid" required="" value="<?php echo !empty($vakantiehuisje['price_per_night'])?$vakantiehuisje['price_per_night']:''; ?>">
									<?php echo form_error('price_per_night','<span class="help-block">','</span>'); ?>
								</div>		
							<br />
								<div class="form-group has-feedback">
									<input type="text" class="form-control" name="price_per_week" placeholder="Price per week &euro;" data-error="Price per week is invalid" required="" value="<?php echo !empty($vakantiehuisje['price_per_night'])?$vakantiehuisje['price_per_night']:''; ?>">
									<?php echo form_error('price_per_night','<span class="help-block">','</span>'); ?>
								</div>		
							<br />							
								<div class="form-group">
									Pets allowed?
										<?php
										if(!empty($vakantiehuisje['Pets']) && $vakantiehuisje['Pets'] == 'Yes'){
							...
							<br />						
								<div class="selectbox">
									Country:<br />
									<select name="country_id" value="country_id" Placeholder="Kies een land">
